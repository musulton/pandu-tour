...
import com.musulton.pandutour.network.ApiServicesKuliner;
import com.musulton.pandutour.network.InitRetrofitKuliner;
...
public class MainActivityKuliner extends AppCompatActivity {
    ...
    private void tampilLokasi() {
        ...
        ApiServicesKuliner api = InitRetrofitKuliner.getInstance();
        // Siapkan request
            ...
            public void onResponse(Call<ResponseLokasi> call, Response<ResponseLokasi> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        AdapterLokasi adapter = new AdapterLokasi(MainActivityKuliner.this, data_lokasi);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(MainActivityKuliner.this, "Data masih kosong", Toast.LENGTH_SHORT).show();
                    }
                }
            }
