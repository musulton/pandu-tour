...
import com.musulton.pandutour.network.ApiServicesPenginapan;
import com.musulton.pandutour.network.InitRetrofitPenginapan;
...
public class MainActivityPenginapan extends AppCompatActivity {
    ...
    private void tampilLokasi() {
        ...
        ApiServicesPenginapan api = InitRetrofitPenginapan.getInstance();
        // Siapkan request
            ...
            public void onResponse(Call<ResponseLokasi> call, Response<ResponseLokasi> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        AdapterLokasi adapter = new AdapterLokasi(MainActivityPenginapan.this, data_lokasi);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(MainActivityPenginapan.this, "Data masih kosong", Toast.LENGTH_SHORT).show();
                    }
                }
            }
